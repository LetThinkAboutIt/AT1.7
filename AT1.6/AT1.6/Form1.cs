...
namespace AT1._6
{
    public partial class Form1 : Form
    {
        ...
        private void BtnSin_Click(object sender, EventArgs e)
        {
            ...
            {
                // Sine calculation
                txtBoxOutput.Text = BasicMath.Trigonometric.Sin(num).ToString();
            }
            else
            {
                // Error handler
        ...
        private void BtnTan_Click(object sender, EventArgs e)
        {
            ...
            if (((Button)sender).Text == "Tan")
            {
                ...
                // Tan calculation
                txtBoxOutput.Text = BasicMath.Trigonometric.Tan(num).ToString();
            }
            else
            {
                // Atan calculation
                txtBoxOutput.Text = BasicMath.Trigonometric.Atan(num).ToString();
            }
        ...
        private void BtnCos_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                // Acos calculation
                txtBoxOutput.Text = BasicMath.Trigonometric.Acos(num).ToString();
            }
        }
        ...
        private void BtnCubeRT_Click(object sender, EventArgs e)
        {
            ...
            if (((Button)sender).Text == "CubeRT")
            {
                if (num >= 0)
                {
                    ...
                    txtBoxOutput.Text = BasicMath.Algebraic.CubeRT(num).ToString();
                }
                else
                {
                    // Cube root calculation
            ...
            {
                // Power 3 calculation
                txtBoxOutput.Text = BasicMath.Algebraic.Pow(num, 3).ToString();
            }
        }
        ...
        private void BtnSQRT_Click(object sender, EventArgs e)
        {
            ...
            {
                // Power 2 calculation
                txtBoxOutput.Text = BasicMath.Algebraic.Pow(num, 2).ToString();
            }
